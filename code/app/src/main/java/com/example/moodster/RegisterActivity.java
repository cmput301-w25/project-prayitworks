...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText etName, etEmail, etUsername, etPassword, etConfirmPassword, etDisplayName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resgister_screen);
    ...
    private void attemptRegistration() {
        ...
        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(email) || TextUtils.isEmpty(username)
                || TextUtils.isEmpty(displayName) || TextUtils.isEmpty(password) || TextUtils.isEmpty(confirmPassword)) {
        ...
        db.collection("Users")
                ...
                .addOnSuccessListener(querySnapshot -> {
                    if (!querySnapshot.isEmpty()) {
                        ...
                        registerUserWithFirebase(email, password, name, username, displayName);
                    }
                })
    ...
    private void registerUserWithFirebase(String email, String password, String name, String username, String displayName) {
        auth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(authResult -> {
                    ...
                    if (user != null) {
                        ...
                        profile.put("followers", new ArrayList<>()); // empty array
